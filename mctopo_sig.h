 ...
 * \ingroup Pi0Ana
 * 
 * \brief Class def header for a class mctopo_sig
 *
 * @author ryan
 */
...
#ifndef LARLITE_MCTOPO_SIG_H
#define LARLITE_MCTOPO_SIG_H
...
namespace larlite {
   ...
   */
  class mctopo_sig : public ana_base{
  
  public:

    /// Default constructor
    mctopo_sig(){ _name="mctopo_sig"; _fout=0;_bothccnc=false; _ccnc=1; _sig = true;  _topo=2; _fid=0.0; _showerenergy=0; _showerdetenergy=0; _showercontain=0;}

    /// Default destructor
    virtual ~mctopo_sig(){}

    /** IMPLEMENT in mctopo_sig.cc!
